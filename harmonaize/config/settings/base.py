...
MIGRATION_MODULES = {"sites": "harmonaize.contrib.sites.migrations"}
...
ADMINS = [("""HarmonAIze Consortium""", "Nicholas.Brink@witsphr.org")]
...
SOCIALACCOUNT_ADAPTER = "harmonaize.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "harmonaize.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "HarmonAIze API",
    "DESCRIPTION": "Documentation of API endpoints of HarmonAIze",
    "VERSION": "1.0.0",
...
OPENAI_TRANSFORMATION_MODEL = env("OPENAI_TRANSFORMATION_MODEL", default="gpt-5.4-mini")
