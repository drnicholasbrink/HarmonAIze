    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('temperature', 'Temperature'), ('precipitation', 'Precipitation'), ('humidity', 'Humidity & Moisture'), ('wind', 'Wind'), ('pressure', 'Atmospheric Pressure'), ('radiation', 'Solar Radiation'), ('evapotranspiration', 'Evapotranspiration'), ('air_quality', 'Air Quality'), ('vegetation', 'Vegetation Indices'), ('cloud_cover', 'Cloud Cover'), ('extreme_events', 'Extreme Events'), ('other', 'Other')], default='other', help_text='Variable category for organizing climate variables. Select from predefined categories to ensure API compatibility.', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reset_existing', models.BooleanField(default=False, help_text='Delete existing climate observations for this study/time window before processing')),
