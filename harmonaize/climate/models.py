...
class ClimateVariable(models.Model):
    ...
    Uses predefined categories to ensure API compatibility and data consistency.
    """
    ...
    category = models.CharField(
        ...
        default='other',
        help_text="Variable category for organizing climate variables. "
                  "Select from predefined categories to ensure API compatibility."
    )
