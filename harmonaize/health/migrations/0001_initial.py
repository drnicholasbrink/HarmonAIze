    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('universal_location', models.ForeignKey(blank=True, help_text='Default source attribute to use as location for all mappings', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='as_universal_location', to='core.attribute')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_column', models.CharField(blank=True, help_text='Column name containing location names', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('value', 'Value'), ('patient_id', 'Patient ID'), ('datetime', 'Date/Time'), ('related_patient_id', 'Related Patient ID'), ('location', 'Location')], default='value', max_length=32)),
                ...
                ('location_attribute', models.ForeignKey(blank=True, help_text='Location attribute to use for this mapping', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='as_location_for_rules', to='core.attribute')),
