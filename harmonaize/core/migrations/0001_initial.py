    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_embedding', pgvector.django.vector.VectorField(blank=True, dimensions=3072, help_text='Vector embedding of the variable name for semantic similarity search', null=True)),
                ('description_embedding', pgvector.django.vector.VectorField(blank=True, dimensions=3072, help_text='Vector embedding of the description for semantic similarity search', null=True)),
                ('name_tsne_x', models.FloatField(blank=True, help_text='X coordinate from t-SNE projection of name embedding', null=True)),
                ('name_tsne_y', models.FloatField(blank=True, help_text='Y coordinate from t-SNE projection of name embedding', null=True)),
                ('description_tsne_x', models.FloatField(blank=True, help_text='X coordinate from t-SNE projection of description embedding', null=True)),
                ('description_tsne_y', models.FloatField(blank=True, help_text='Y coordinate from t-SNE projection of description embedding', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Location',
        ...
        migrations.AddField(
            ...
            name='study',
            field=models.ForeignKey(blank=True, help_text='Study that defined this attribute', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='attributes', to='core.study'),
        ),
        migrations.CreateModel(
            name='StudyDocument',
            fields=[
